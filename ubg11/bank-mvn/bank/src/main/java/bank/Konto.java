...
public abstract class Konto implements Comparable<Konto> {
    ...
    */
    ...
    protected void setKontostand(double kontostand) {
    	double oldKontostand = getKontostand();
    ...
    public final void setInhaber(Kunde kinh) throws GesperrtException{
        ...
        Kunde oldInhaber = getInhaber();
        this.inhaber = kinh;
        prop.firePropertyChange("Inhaber", oldInhaber, kinh);
    ...
    public boolean abheben(double betrag) throws GesperrtException{
        ...
        if(abhebenGiro(betrag) == true){
            return true;
        }
        if (abhebenSpar(betrag) == true){
            return true;
        }
       return false;
    }

    public abstract boolean abhebenGiro (double betrag) throws GesperrtException;

    public abstract boolean abhebenSpar (double betrag) throws GesperrtException;
    /**
    ...
    public void abmelnden(PropertyChangeListener b){
